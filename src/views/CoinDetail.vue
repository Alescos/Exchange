...
export default {
  ...
  computed: {
    ...
    min() {
      return Math.min(
        // se pasa el elemento history mapeado
  ...
  methods: {
    ...
    getWebSite(exchange){
      ...
      return api.getExchange(exchange.exchangeId)
        .then(res =>{
          ...
          // los problemas de reactividad se pueden solucionar con set
    ...
    getCoin() {
      ...
      this.isLoading = true;
      /* La función Promise.all permite ejecutar varias promesas de manera
    simultanea */
      Promise.all([
        api.getAsset(id),
        ...
        // se obtienen las respuestas de las promesas
